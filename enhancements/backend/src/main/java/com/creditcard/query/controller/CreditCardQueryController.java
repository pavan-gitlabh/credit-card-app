...
public class CreditCardQueryController {
	...
	@Autowired
	public CreditCardQueryController(RedisTemplate<String, CreditCardView> redisTemplate) {
		this.redisTemplate = redisTemplate;
	}

	@GetMapping
	public List<CreditCardView> getAllCards() {
		return redisTemplate.opsForValue().multiGet(redisTemplate.keys("card:*"));
	}
}